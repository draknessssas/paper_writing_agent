...
This folder stores current-manuscript analysis. These files are not style memory.
...
Current experimental results, table values, figure descriptions, reviewer comments, and allowed/forbidden claims belong here or in the live conversation, not in `corpora/my_papers` or `corpora/domain_papers`.
